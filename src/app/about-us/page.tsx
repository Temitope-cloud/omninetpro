        ...
        <div className="grid gap-12 md:grid-cols-2">
          <div className="lg:w-3/4">
            ...
            <p className="mt-3 text-gray-800">
              We create clean, conversion-focused digital experiences that help
              businesses launch fast, scale confidently, and succeed in today’s
              online marketplace.
            </p>
            <p className="mt-5">
              <a
          ...
          <div className="space-y-6 lg:space-y-10">
            ...
            <div className="flex gap-x-5 sm:gap-x-8">
              ...
              <div className="grow">
                ...
                <p className="mt-1 text-gray-600">
                  Our easy-to-follow documentation and training resources make
                  it simple for business owners to manage, update, and
                  understand their eCommerce platforms without stress.
                </p>
              </div>
            </div>
            {/* End Icon Block */}
            ...
            <div className="flex gap-x-5 sm:gap-x-8">
              ...
              <div className="grow">
                ...
                <p className="mt-1 text-gray-600">
                  From technical fixes to growth recommendations, our team
                  provides ongoing assistance—ensuring your store runs smoothly
                  long after launch.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-x-5 sm:gap-x-8">
              ...
              <div className="grow">
                ...
                <p className="mt-1 text-gray-600">
                  From store setup to marketing automation, we deliver practical
                  eCommerce solutions that help businesses grow online—without
                  breaking the bank.
                </p>
              </div>
            </div>
