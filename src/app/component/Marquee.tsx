...
const testimonials = [
  {
    name: "Ava Green",
    username: "@ava",
    body: "Omninetpro delivered fast. Taiwo excels.",
  ...
  },
  {
    name: "Ana Miller",
    username: "@ana",
    body: "Taiwo made everything super easy.",
  ...
  },
  {
    name: "Mateo Rossi",
    username: "@mat",
    body: "Omninetpro boosted my results instantly.",
  ...
  },
  {
    name: "Maya Patel",
    username: "@maya",
    body: "Taiwo's expertise grew my sales.",
  ...
  },
  {
    name: "Noah Smith",
    username: "@noah",
    body: "Omninetpro transformed my store quickly.",
  ...
  },
  {
    name: "Lucas Stone",
    username: "@luc",
    body: "Fast upgrades, thanks to Taiwo.",
  ...
  },
  {
    name: "Haruto Sato",
    username: "@haru",
    body: "Omninetpro exceeded expectations again.",
  ...
  },
  {
    name: "Emma Lee",
    username: "@emma",
    body: "Smooth experience. Taiwo guided perfectly.",
  ...
  },
  {
    name: "Carlos Ray",
    username: "@carl",
    body: "My business grew with Omninetpro.",
...
export default function MarqueeDefault() {
  return (
    <div className="relative flex w-screen flex-col items-center justify-center gap-1 overflow-hidden py-8">
