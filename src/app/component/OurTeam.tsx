    ...
    <>
      <div className="max-w-340 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="">
              <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
                <div className="flex items-center gap-x-4">
                  <img
                    className="rounded-full size-20 object-cover object-top"
                    src={team.image}
                    alt={team.title}
                  />
                  <div className="grow">
          ...
          <a
            className="col-span-full lg:col-span-1 group flex flex-col justify-center text-center rounded-xl p-4 md:p-6 border border-dashed border-gray-200 hover:shadow-2xs focus:outline-hidden focus:shadow-2xs"
            href="#"
          >
            <h3 className="text-lg text-gray-800">
              We've got a lot more to handle your project
            </h3>
            <div>
