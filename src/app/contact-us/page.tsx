              ...
              <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 md:gap-8 lg:gap-12">
                <div className="flex gap-4">
                  ...
                  <div className="grow">
                    ...
                    <p>
                      <a
                        className="relative inline-block font-medium text-black before:absolute before:start-0 before:bottom-0.5 before:-z-1 before:h-1 before:w-full before:bg-yellow-400 hover:before:bg-black focus:outline-hidden focus:before:bg-black"
