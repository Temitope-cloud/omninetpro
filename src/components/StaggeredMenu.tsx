    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* <img
              ...
              height={24}
            /> */}
            <h2 className="text-3xl font-bold">OmninetPro</h2>
          </div>

          <button
            ref={toggleBtnRef}
            className={`sm-toggle pointer-events-auto relative inline-flex cursor-pointer items-center gap-[0.3rem] overflow-visible border-0 bg-transparent leading-none font-medium ${
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 z-10 flex h-full flex-col overflow-y-auto bg-white p-[6em_2em_2em_2em] backdrop-blur-[12px]"
            ...
            >
              {items && items.length ? (
                items.map((it, idx) => (
                  ...
                  >
                    <a
                      className="sm-panel-item relative inline-block cursor-pointer pr-[1.4em] text-[4rem] leading-none font-semibold tracking-[-2px] text-black uppercase no-underline transition-[background,color] duration-150 ease-linear"
                      href={it.link}
